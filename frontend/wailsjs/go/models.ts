export namespace dto {
	...
	export class AnalyzeOptions {
	    ...
	    static createFrom(source: any = {}) {
	        return new AnalyzeOptions(source);
	    }
	...
	export class PrivacyMetrics {
	    textLengthDist: Record<string, number>;
	    thinkingLengthDist: Record<string, number>;
	    commandHashDist: Record<string, number>;
	    toolOutputDist: Record<string, number>;
	
	    static createFrom(source: any = {}) {
	        return new PrivacyMetrics(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.textLengthDist = source["textLengthDist"];
	        this.thinkingLengthDist = source["thinkingLengthDist"];
	        this.commandHashDist = source["commandHashDist"];
	        this.toolOutputDist = source["toolOutputDist"];
	    }
	}
	export class ParseErrorInfo {
	    ...
	    static createFrom(source: any = {}) {
	        return new ParseErrorInfo(source);
	    }
	...
	export class AnalyzeResult {
	    ...
	    fieldPaths: Record<string, any>;
	    contentTypes: Record<string, number>;
	    toolNames: Record<string, number>;
	    usageKeys: Record<string, number>;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.parseErrors = this.convertValues(source["parseErrors"], ParseErrorInfo);
	        this.fieldPaths = source["fieldPaths"];
	        this.contentTypes = source["contentTypes"];
	        this.toolNames = source["toolNames"];
	        this.usageKeys = source["usageKeys"];
	        this.privacyMetrics = this.convertValues(source["privacyMetrics"], PrivacyMetrics);
	    }
